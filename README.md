## rqt_rviz (noetic) - 0.7.2-1

The packages in the `rqt_rviz` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --rosdistro noetic rqt_rviz` on `Sat, 26 Apr 2025 22:26:47 -0000`
